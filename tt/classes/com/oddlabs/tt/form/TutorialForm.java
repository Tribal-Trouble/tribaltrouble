...
public final strictfp class TutorialForm extends Form {
    ...
    private static final ResourceBundle bundle =
            ResourceBundle.getBundle(TutorialForm.class.getName());

    private final GUIRoot gui_root;
    private final NetworkSelector network;

    private static final String formatTutorial(int tutorial_number) {
        return Utils.getBundleString(
                bundle, "tutorial", new Object[] {Integer.toString(tutorial_number)});
    }
    ...
    public TutorialForm(NetworkSelector network, GUIRoot gui_root) {
        ...
        Label headline =
                new Label(
                        Utils.getBundleString(bundle, "tutorial_caption"),
        ...
        Label label_tutorial1 =
                new Label(
                        Utils.getBundleString(bundle, "tutorial1_tip"),
        ...
        Label label_tutorial2 =
                new Label(
                        Utils.getBundleString(bundle, "tutorial2_tip"),
                        Skin.getSkin().getEditFont());
        ...
        Label label_tutorial3 =
                new Label(
                        Utils.getBundleString(bundle, "tutorial3_tip"),
                        Skin.getSkin().getEditFont());
        ...
        Label label_tutorial4 =
                new Label(
                        Utils.getBundleString(bundle, "tutorial4_tip"),
                        Skin.getSkin().getEditFont());
        ...
        Label label_tutorial5 =
                new Label(
                        Utils.getBundleString(bundle, "tutorial5_tip"),
                        Skin.getSkin().getEditFont());
        ...
        Label label_tutorial6 =
                new Label(
                        Utils.getBundleString(bundle, "tutorial6_tip"),
                        Skin.getSkin().getEditFont());
    ...
    private static final strictfp class TutorialAction implements WorldInitAction {
    ...
    private static void startNewGame(
            NetworkSelector network, GUIRoot gui_root, TriggerFactory factory, int tutorial_num) {
        ...
        GameNetwork game_network =
                doStartNewGame(
                        ...
                        gui_root,
                        ingame_info,
                        new TutorialAction(factory, ingame_info),
    ...
    private static GameNetwork doStartNewGame(
            ...
            final WorldInitAction initial_action,
        ...
        WorldInitAction compound_action =
                new WorldInitAction() {
                    public final void run(WorldViewer world_viewer) {
                        if (initial_action != null) initial_action.run(world_viewer);
                        MainMenu.completeGameSetupHack(world_viewer);
                    }
                };
        return MainMenu.startNewGame(
                network,
                gui_root,
                null,
                new WorldParameters(
                ...
                if (!Renderer.isRegistered()) {
                    ...
                    Form demo_form =
                            new DemoForm(
                                    ...
                                    new GUIImage(
                                            512, 256, 0f, 0f, 1f, 1f, "/textures/gui/demo_towers"),
    ...
    public static final void startTutorial(
            NetworkSelector network, GUIRoot gui_root, int tutorial_number) {
            ...
            case TUTORIAL_TOWER:
                        ...
                        new WorldInitAction() {
                            public final void run(WorldViewer viewer) {
                                ...
                                new Tutorial(
                                        viewer,
                                        ingame_info,
                                        new SelectTowerTrigger(viewer.getLocalPlayer()));
                            }
                        };
                ...
                game_network
                        ...
                        .setPlayerSlot(
                                ...
                                0,
                                true,
                                PlayerSlot.AI_TOWER_TUTORIAL);
                game_network
                        .getClient()
                        .setUnitInfo(0, new UnitInfo(false, false, 0, false, 10, 0, 0, 0));
                game_network
                        .getClient()
                        .getServerInterface()
                        .setPlayerSlot(
                ...
                game_network
                        .getClient()
                        .setUnitInfo(1, new UnitInfo(false, false, 0, false, 0, 0, 0, 0));
                game_network.getClient().getServerInterface().startServer();
                break;
            case TUTORIAL_CHIEFTAIN:
                ingame_info = new TutorialInGameInfo();
                game_network =
                        doStartNewGame(
                                ...
                                new TutorialAction(
                                        new TriggerFactory() {
                                            public final TutorialTrigger create(
                                                    WorldViewer viewer) {
                                                return new BuildingChieftainTrigger(
                ...
                game_network
                        ...
                        .setPlayerSlot(
                                ...
                                1,
                                true,
                                PlayerSlot.AI_CHIEFTAIN_TUTORIAL);
                game_network
                        .getClient()
                        .setUnitInfo(1, new UnitInfo(false, false, 0, false, 0, 0, 0, 0));
                game_network.getClient().getServerInterface().startServer();
            ...
            case TUTORIAL_BATTLE:
                ...
                game_network
                        ...
                        .setPlayerSlot(
                                ...
                                1,
                                true,
                                PlayerSlot.AI_BATTLE_TUTORIAL);
                game_network
                        .getClient()
                        .setUnitInfo(1, new UnitInfo(true, true, 0, false, 0, 15, 0, 0));
                game_network.getClient().getServerInterface().startServer();
                break;
            default:
