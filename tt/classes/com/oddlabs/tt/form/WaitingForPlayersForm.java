...
public final strictfp class WaitingForPlayersForm extends Form {
    ...
    private final ResourceBundle bundle =
            ResourceBundle.getBundle(WaitingForPlayersForm.class.getName());
    ...
    public WaitingForPlayersForm(WorldViewer viewer) {
        ...
        info_label =
                new Label(
                        Utils.getBundleString(bundle, "waiting"), Skin.getSkin().getHeadlineFont());
    ...
    private final strictfp class AbortListener implements MouseClickListener {
        public final void mouseClicked(int button, int x, int y, int clicks) {
            viewer.getGUIRoot()
                    .addModalForm(
                            new QuestionForm(
                                    Utils.getBundleString(bundle, "confirm_abort"),
                                    new CancelListener(WaitingForPlayersForm.this)));
        }
    }
}
