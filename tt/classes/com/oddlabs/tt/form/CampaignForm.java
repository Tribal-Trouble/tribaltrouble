...
public final strictfp class CampaignForm extends Form
    ...
    public CampaignForm(NetworkSelector network, GUIRoot gui_root, Menu main_menu) {
        ...
        Label headline =
                new Label(
                        Utils.getBundleString(bundle, "campaign"),
    ...
    private final strictfp class DeleteListener implements MouseClickListener {
        public final void mouseClicked(int button, int x, int y, int clicks) {
            ...
            if (state != null) {
                String confirm_str =
                        Utils.getBundleString(
                                bundle, "confirm_delete", new Object[] {state.getName()});
    ...
    private final strictfp class LoadListener implements MouseClickListener, RowListener {
        public final void mouseClicked(int button, int x, int y, int clicks) {
            ...
            if (selected != null) load((CampaignState) selected);
        }
