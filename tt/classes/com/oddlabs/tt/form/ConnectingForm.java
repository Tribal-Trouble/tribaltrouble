...
public final strictfp class ConnectingForm extends Form implements ConfigurationListener {
    ...
    public ConnectingForm(
            GameNetwork game_network, GUIRoot gui_root, SelectGameMenu owner, boolean multiplayer) {
        ...
        if (multiplayer)
            info_label =
                    new Label(
                            Utils.getBundleString(bundle, "connecting"),
                            Skin.getSkin().getHeadlineFont());
        else
            info_label =
                    new Label(
                            Utils.getBundleString(bundle, "starting"),
                            Skin.getSkin().getHeadlineFont());
        addChild(info_label);
    ...
    public final void connected(
        ...
        if (multiplayer) {
            ...
            if (game.isRated()) team = player_slot % 2;
