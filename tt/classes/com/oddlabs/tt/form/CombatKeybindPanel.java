...
/**
 * Combat keybinds panel containing all military and combat-related controls. Includes army groups,
 * chieftain magic, and tower actions.
 */
public class CombatKeybindPanel extends AbstractKeybindPanel {
    ...
    protected List<Section> getSections() {
        // Swap Chieftain and Tower sections: Chieftain Magic first, then Tower Actions, then Army
        // Groups
