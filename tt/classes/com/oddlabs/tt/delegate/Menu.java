...
public abstract strictfp class Menu extends CameraDelegate {
    ...
    private void init() {
        ...
        overlay = new GUIImage(screen_width, screen_height, 0f, 0f, (float) overlay_image_width / overlay_texture_width, (float) overlay_image_height / overlay_texture_height, overlay_texture_name, false);
        overlay.setPos(0, 0);
        addChild(overlay);
