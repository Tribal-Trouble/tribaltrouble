...
public final strictfp class ServerMessageBundler {
    private static final ResourceBundle bundle =
            ResourceBundle.getBundle(ServerMessageBundler.class.getName());

    public static final String getSizeString(int index) {
        switch (index) {
    ...
    public static final String getTerrainTypeString(int index) {
        switch (index) {
    ...
    public static final String getRatedString(boolean rated) {
        if (rated) return Utils.getBundleString(bundle, "rated_yes");
        else return Utils.getBundleString(bundle, "rated_no");
    }

    public static final String getGamespeedString(int index) {
        switch (index) {
    ...
    public static final String getHillsString(int index) {
        return (10 * index) + "%";
    }

    public static final String getTreesString(int index) {
        return (10 * index) + "%";
    }

    public static final String getSuppliesString(int index) {
        return (10 * index) + "%";
    }

    public static final String getRegistrationKeyFormatExceptionMessage(
            RegistrationKeyFormatException e) {
        switch (e.getType()) {
            case RegistrationKeyFormatException.TYPE_INVALID_CHAR:
                return Utils.getBundleString(
                        bundle, "invalid_char", new Object[] {new Character(e.getInvalidChar())});
            case RegistrationKeyFormatException.TYPE_INVALID_LENGTH:
                return Utils.getBundleString(
                        bundle,
                        "invalid_length",
                        new Object[] {new Integer(e.getStrippedLength())});
