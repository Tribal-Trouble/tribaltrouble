...
public strictfp class SceneryModel extends Model implements Occupant, ModelToolTip, Animated {
    ...
    public SceneryModel(
            World world, float x, float y, float dir_x, float dir_y, SpriteKey sprite_renderer) {
    ...
    public SceneryModel(
            ...
            String name,
            int animation,
            float seconds_per_animation_cycle,
            float anim_offset) {
        super(world);
    ...
    protected void doRegister() {
        ...
        if (animation > -1) getWorld().getAnimationManagerGameTime().registerAnimation(this);
    }
    ...
    public final void remove() {
        ...
        if (animation > -1) getWorld().getAnimationManagerGameTime().removeAnimation(this);
    }
    ...
    public final int getAnimation() {
        if (animation > -1) return animation;
        else return 0;
    }
