...
public final strictfp class RacesResources {
    ...
    public static final int SHIP_HIT_POINTS = 150;
    ...
    public static final ResourceDescriptor DEFAULT_SHADOW_DESC =
            new GeneratorHalos(
                    128,
                    new float[][] {{0f, 0.75f}, {0.5f, 0f}},
                    new float[][] {{0.40f, 0f}, {0.41f, 1f}, {0.48f, 1f}, {0.49f, 0f}});

    private static final ResourceBundle bundle =
            ResourceBundle.getBundle(RacesResources.class.getName());
    private static final String[] race_names =
            new String[] {
                Utils.getBundleString(bundle, "natives"), Utils.getBundleString(bundle, "vikings")
            };
    ...
    private static final BuildingTemplate createBuildingTemplate(
        ...
        ResourceDescriptor building_shadow_desc =
                new GeneratorHalos(
                        256,
    ...
    public RacesResources(RenderQueues queues) {
        ...
        SpriteFile native_wood_sprite =
                new SpriteFile(
                        "/geometry/natives/wood_resource.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
                        false);
        SpriteFile native_rubber_sprite =
                new SpriteFile(
                        "/geometry/natives/rubber_resource.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
        ...
        SpriteFile viking_wood_sprite =
                new SpriteFile(
                        "/geometry/vikings/wood_resource.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
                        false);
        SpriteFile viking_rubber_sprite =
                new SpriteFile(
                        "/geometry/vikings/rubber_resource.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
                        false);
        ProgressForm.progress(1f / num_progress);
        SpriteFile viking_rock_sprite =
                new SpriteFile(
                        "/geometry/vikings/rock_resource.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
        ...
        note_textures[0] =
                queues.registerTexture(
                        new TextureFile(
                                "/textures/effects/note1",
        ...
        Audio death_peon_sound =
                (Audio) Resources.findResource(new AudioFile("/sfx/death_peon.ogg"));
        Audio death_viking1_sound =
                (Audio) Resources.findResource(new AudioFile("/sfx/death_viking_warrior1.ogg"));
        Audio death_viking2_sound =
                (Audio) Resources.findResource(new AudioFile("/sfx/death_viking_warrior2.ogg"));
        Audio death_native1_sound =
                (Audio) Resources.findResource(new AudioFile("/sfx/death_native_warrior1.ogg"));
        Audio death_native2_sound =
                (Audio) Resources.findResource(new AudioFile("/sfx/death_native_warrior2.ogg"));

        Audio axe_throw_sound =
                (Audio) Resources.findResource(new AudioFile("/sfx/weapon_axe.ogg"));
        Audio spear_throw_sound =
                (Audio) Resources.findResource(new AudioFile("/sfx/weapon_spear.ogg"));

        tree_fall_sound = new Audio[2];
        tree_fall_sound[AbstractTreeGroup.TREE_INDEX] =
                (Audio) Resources.findResource(new AudioFile("/sfx/felling_tree.ogg"));
        tree_fall_sound[AbstractTreeGroup.PALMTREE_INDEX] =
                (Audio) Resources.findResource(new AudioFile("/sfx/felling_palmtree.ogg"));
        ...
        building_collapse_sound =
                (Audio) Resources.findResource(new AudioFile("/sfx/building_crash.ogg"));
        ...
        BuildingTemplate viking_quarters_template =
        ...
        SpriteFile sprite_list_native_warrior =
                new SpriteFile(
                        ...
                        false);
        ProgressForm.progress(1f / num_progress);
        SpriteFile viking_warrior_axe =
                new SpriteFile(
                        "/geometry/vikings/axe.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
                        false);
        ProgressForm.progress(1f / num_progress);
        SpriteFile native_warrior_spear =
                new SpriteFile(
                        "/geometry/natives/spear.binsprite",
                        Globals.NO_MIPMAP_CUTOFF,
                        true,
                        true,
                        true,
        ...
        WeaponFactory viking_warrior_rock_weapon =
                new ThrowingFactory(
                        RockAxeWeapon.class,
                        0.5f,
                        THROW_RANGE,
                        ...
                        axe_throw_sound,
                        unit_hit_sounds);
        WeaponFactory viking_warrior_iron_weapon =
                new ThrowingFactory(
                        IronAxeWeapon.class,
                        0.75f,
                        THROW_RANGE,
                        ...
                        axe_throw_sound,
                        unit_hit_sounds);
        WeaponFactory viking_warrior_rubber_weapon =
                new ThrowingFactory(
                        ...
                        axe_throw_sound,
                        unit_hit_sounds);
        WeaponFactory native_warrior_rock_weapon =
                new ThrowingFactory(
                        ...
                        spear_throw_sound,
                        unit_hit_sounds);
        WeaponFactory native_warrior_iron_weapon =
                new ThrowingFactory(
                        ...
                        spear_throw_sound,
                        unit_hit_sounds);
        WeaponFactory native_warrior_rubber_weapon =
                new ThrowingFactory(
        ...
        Audio[] native_chieftain_hit_sounds =
                new Audio[] {
        ...
        Audio[] viking_chieftain_hit_sounds =
                new Audio[] {
        ...
        ProgressForm.progress(1f / num_progress);
        ShadowListKey default_shadow_list =
                queues.registerSelectableShadowList(DEFAULT_SHADOW_DESC);
        UnitTemplate viking_warrior_rock_template =
                new UnitTemplate(
                        .4f,
                        1.2f,
                        ...
                        2f,
                        3);
        UnitTemplate viking_warrior_iron_template =
                new UnitTemplate(
                        .4f,
                        1.2f,
                        new Abilities(Abilities.ATTACK | Abilities.TARGET | Abilities.THROW),
                        ...
                        2f,
                        5);
        UnitTemplate viking_warrior_rubber_template =
                new UnitTemplate(
                        .4f,
                        1.2f,
                        new Abilities(Abilities.ATTACK | Abilities.TARGET | Abilities.THROW),
                        ...
                        2f,
                        10);
        UnitTemplate native_warrior_rock_template =
                new UnitTemplate(
                        .4f,
                        1.2f,
                        new Abilities(Abilities.ATTACK | Abilities.TARGET | Abilities.THROW),
                        ...
                        2f,
                        3);
        UnitTemplate native_warrior_iron_template =
                new UnitTemplate(
                        .4f,
                        1.2f,
                        new Abilities(Abilities.ATTACK | Abilities.TARGET | Abilities.THROW),
                        ...
                        2f,
                        5);
        UnitTemplate native_warrior_rubber_template =
                new UnitTemplate(
                        .4f,
                        1.2f,
                        new Abilities(Abilities.ATTACK | Abilities.TARGET | Abilities.THROW),
                        ...
                        2f,
                        10);
        UnitTemplate viking_peon_template =
                new UnitTemplate(
                        .4f,
                        1.1f,
                        new Abilities(
                        ...
                        new UnitSupplyContainerFactory(
                                MAX_UNIT_RESOURCES, viking_supply_sprite_lists),
                        death_peon_sound,
                        .25f,
                        new float[] {.7f},
                        1f,
                        ...
                        1.75f,
                        1);
        UnitTemplate native_peon_template =
                new UnitTemplate(
                        .4f,
                        1.1f,
                        new Abilities(
                        ...
                        default_shadow_list,
                        new UnitSupplyContainerFactory(
                                MAX_UNIT_RESOURCES, native_supply_sprite_lists),
                        death_peon_sound,
                        .25f,
                        new float[] {.7f},
                        1f,
                        ...
                        1.75f,
                        1);
        UnitTemplate viking_chieftain_template =
                new UnitTemplate(
                        .4f,
                        1.4f,
                        ...
                        2.7f,
                        40);
        UnitTemplate native_chieftain_template =
                new UnitTemplate(
                        .4f,
                        1.4f,
                        new Abilities(Abilities.ATTACK | Abilities.TARGET | Abilities.MAGIC),
        ...
        native_magic[INDEX_MAGIC_POISON] =
                new PoisonFogFactory(
                        0.9f, 0f, 0.55f, 26f, .5f, 2f, 20f, 10, 5f, 80f / 224f, 163f / 224f);
        native_magic[INDEX_MAGIC_LIGHTNING] =
                new LightningCloudFactory(
                        0.9f, 0f, 0.55f, 22f, 1f, 8f, 1f, 30, 18f, 5f, 80f / 224f, 163f / 224f);

        MagicFactory[] viking_magic = new MagicFactory[NUM_MAGIC];
        viking_magic[INDEX_MAGIC_STUN] =
                new StunFactory(2.57f, 0f, 3.8f, 36f, 30f, 10f, 6f, 57f / 159f, 100f / 159f);
        viking_magic[INDEX_MAGIC_BLAST] =
                new SonicBlastFactory(
                        2.57f, 0f, 3.8f, 36f, 17f, 2f, 150, 30, .8f, 6f, 57f / 159f, 100f / 159f);
        ...
        Race natives_race =
                new Race(
                        ...
                        queues.register(
                                new SpriteFile(
                                        "/geometry/natives/rally_point.binsprite",
                                        Globals.NO_MIPMAP_CUTOFF,
                                        true,
                                        true,
                                        true,
                        ...
                        (Audio)
                                Resources.findResource(
                                        new AudioFile("/sfx/attacknotify_native.ogg")),
                        (Audio)
                                Resources.findResource(
                                        new AudioFile("/sfx/buildingnotify_native.ogg")),
                        native_magic,
        ...
        Race vikings_race =
                new Race(
                        ...
                        queues.register(
                                new SpriteFile(
                                        "/geometry/vikings/rally_point.binsprite",
                                        Globals.NO_MIPMAP_CUTOFF,
                                        true,
                                        true,
                                        true,
                        ...
                        (Audio)
                                Resources.findResource(
                                        new AudioFile("/sfx/attacknotify_viking.ogg")),
                        (Audio)
                                Resources.findResource(
                                        new AudioFile("/sfx/buildingnotify_viking.ogg")),
                        viking_magic,
                        new VikingChieftainAI(),
                        "/music/viking.ogg");
        races = new Race[] {natives_race, vikings_race};

        wood_fragment_sprites[0] =
                queues.register(
                        new SpriteFile(
                                "/geometry/misc/wood_2.binsprite",
                                Globals.NO_MIPMAP_CUTOFF,
                                true,
                                true,
                                true,
                                false),
                        0);
        wood_fragment_sprites[1] =
                queues.register(
                        new SpriteFile(
                                "/geometry/misc/wood_3.binsprite",
                                Globals.NO_MIPMAP_CUTOFF,
                                true,
                                true,
                                true,
                                false));
        wood_fragment_sprites[2] =
                queues.register(
                        new SpriteFile(
                                "/geometry/misc/wood_4.binsprite",
                                Globals.NO_MIPMAP_CUTOFF,
                                true,
                                true,
                                true,
                                false));
        wood_fragment_sprites[3] =
                queues.register(
                        new SpriteFile(
                                "/geometry/misc/wood_5.binsprite",
                                Globals.NO_MIPMAP_CUTOFF,
                                true,
                                true,
                                true,
        ...
        treasure_sprites[1] =
                queues.register(
                        new SpriteFile(
                                "/geometry/misc/treasure_1.binsprite",
                                Globals.NO_MIPMAP_CUTOFF,
                                true,
                                true,
                                true,
        ...
        treasure_sprites[2] =
                queues.register(
                        new SpriteFile(
                                "/geometry/misc/treasure_2.binsprite",
                                Globals.NO_MIPMAP_CUTOFF,
                                true,
                                true,
                                true,
        ...
        treasure_sprites[3] =
                queues.register(
                        new SpriteFile(
                                "/geometry/misc/treasure_3.binsprite",
                                Globals.NO_MIPMAP_CUTOFF,
                                true,
                                true,
                                true,
        ...
        treasure_sprites[4] =
                queues.register(
                        new SpriteFile(
                                "/geometry/misc/treasure_4.binsprite",
                                Globals.NO_MIPMAP_CUTOFF,
                                true,
                                true,
                                true,
        ...
        treasure_sprites[5] =
                queues.register(
                        new SpriteFile(
                                "/geometry/misc/treasure_5.binsprite",
                                Globals.NO_MIPMAP_CUTOFF,
                                true,
                                true,
                                true,
    ...
    public static final String getRaceName(int i) {
        return race_names[i];
    }

    public static final int getNumRaces() {
