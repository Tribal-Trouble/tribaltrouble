...
public final strictfp class SonicBlast implements Magic {
    ...
    public SonicBlast(
            ...
            float offset_z,
            float hit_radius,
            float hit_chance_closest,
            float hit_chance_farthest,
            int damage_closest,
            int damage_farthest,
            float seconds,
            Unit src) {
        ...
        start_x =
                src.getPositionX()
                        + offset_x * src.getDirectionX()
                        - offset_y * (-src.getDirectionY());
        start_y =
                src.getPositionY()
                        + offset_x * src.getDirectionY()
                        + offset_y * src.getDirectionX();
        start_z = src.getPositionZ() + offset_z;

        FindOccupantFilter filter =
                new FindOccupantFilter(
                        src.getPositionX(), src.getPositionY(), hit_radius, src, Selectable.class);
                ...
                owner.getWorld()
                        ...
                        .newAudio(
                                new AudioParameters(
                                        owner.getWorld()
                                                .getRacesResources()
                                                .getBlastLurSound(owner.getWorld().getRandom()),
                                        start_x,
                                        start_y,
                                        start_z,
        ...
        rumble =
                owner.getWorld()
                        ...
                        .newAudio(
                                new AudioParameters(
                                        owner.getWorld().getRacesResources().getBlastRumbleSound(),
                                        start_x,
                                        start_y,
                                        start_z,
                                        AudioPlayer.AUDIO_RANK_MAGIC,
    ...
    public final void animate(float t) {
        ...
        if (!first_ring_sent) {
            ...
            new RingEmitter(
                    owner.getWorld(),
                    new Vector3f(start_x, start_y, start_z),
                    .5f,
                    0.01f,
                    1f,
                    45,
                    1000f,
                    new Vector3f(0f, 0f, 27f),
                    new Vector3f(0f, 0f, 0f),
                    new Vector4f(1f, 1f, 1f, alpha_start),
                    new Vector4f(0f, 0f, 0f, -alpha_start / energy),
                    new Vector3f(.2f, .2f, .5f),
                    new Vector3f(3.5f, 3.7f, .5f),
                    energy,
                    1f,
                    GL11.GL_SRC_ALPHA,
                    GL11.GL_ONE,
            ...
            owner.getWorld()
                    ...
                    .newAudio(
                            new AudioParameters(
                                    owner.getWorld().getRacesResources().getBlastBlastSound(),
                                    start_x,
                                    start_y,
                                    start_z,
                                    AudioPlayer.AUDIO_RANK_MAGIC,
        ...
        while (rings_sent <= NUM_RINGS
                && rings_sent < time / SECONDS_BETWEEN_RINGS
                && time >= SECONDS_AFTER_FIRST) {
            rings_sent++;
            float alpha_start = .8f;
            ...
            new RingEmitter(
                    ...
                    15,
                    1000f,
                    new Vector3f(0f, 0f, velocity),
                    new Vector3f(0f, 0f, 0f),
                    new Vector4f(1f, 1f, 1f, alpha_start),
                    new Vector4f(0f, 0f, 0f, -alpha_start / energy),
                    new Vector3f(.2f, .2f, .5f),
                    new Vector3f(12.5f, 12.5f, .5f),
                    energy,
                    1f,
                    GL11.GL_SRC_ALPHA,
                    GL11.GL_ONE,
        ...
        while (i < target_list.size()) {
            ...
            if (squared_dist < squared_radius) {
                if (!s.isDead()) {
                    float hit_chance =
                            calculateValueFromCurrentRadius(
                                    current_radius, hit_chance_closest, hit_chance_farthest);
                    if (owner.getWorld().getRandom().nextFloat()
                            < hit_chance * (1 - s.getDefenseChance())) {
                        int damage =
                                (int)
                                        calculateValueFromCurrentRadius(
                                                current_radius, damage_closest, damage_farthest);
    ...
    private final float calculateValueFromCurrentRadius(
            float current_radius, float max, float min) {
