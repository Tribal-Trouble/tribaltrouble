...
public final strictfp class RubberAxeWeapon extends RotatingThrowingWeapon {
    ...
    private static final float BOUNCING_METERS_PER_SECOND =
            10; // multiplied by meters/second (in 2D)

    private boolean bouncing = false;

    public RubberAxeWeapon(
            boolean hit,
            Unit src,
            Selectable target,
    ...
    protected final float getMetersPerSecond() {
        if (bouncing) return BOUNCING_METERS_PER_SECOND;
        else return METERS_PER_SECOND;
    }
