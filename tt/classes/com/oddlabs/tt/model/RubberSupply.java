...
public final strictfp class RubberSupply extends SupplyModel implements Animated, Movable {
    ...
    private static final float[] ANIMATION_SPEEDS;
        ...
        this.spawn_z =
                offset_z =
                        world.getRandom().nextFloat()
                                        * (MAX_TREE_FALL_HEIGHT - MIN_TREE_FALL_HEIGHT)
        ...
        if (animation == ANIMATION_FLYING || animation == ANIMATION_RUNNING) {
            ...
            if (random < .75) {
                ...
                if (random < .05)
                    getWorld()
                            ...
                            .newAudio(
                                    new AudioParameters(
                                            getWorld()
                                                    .getLandscapeResources()
                                                    .getBirdIdleSound(getWorld().getRandom()),
                                            getPositionX(),
                                            getPositionY(),
                                            getPositionZ(),
                ...
                int new_grid_x =
                        start_grid_x
                                + (int)
                                        ((getWorld().getRandom().nextFloat() * 2 - 1)
                                                * MAX_MOVE_GRIDS);
                int new_grid_y =
                        start_grid_y
                                + (int)
                ...
                if (move_random < .25f) {
                    ...
                    getWorld()
                            ...
                            .newAudio(
                                    new AudioParameters(
                                            getWorld().getLandscapeResources().getBirdPeckSound(),
                                            getPositionX(),
                                            getPositionY(),
                                            getPositionZ(),
                                            AudioPlayer.AUDIO_RANK_CHICKEN,
    ...
    public final boolean hit() {
        if (!is_hit) {
            ...
            getWorld()
                    ...
                    .newAudio(
                            new AudioParameters(
                                    getWorld().getLandscapeResources().getBirdDeathSound(),
                                    getPositionX(),
                                    getPositionY(),
                                    getPositionZ(),
