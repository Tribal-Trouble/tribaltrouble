...
public strictfp class Label extends TextField implements Comparable {
    ...
    public static final float[] DEFAULT_COLOR = new float[] {1f, 1f, 1f, 1f};
    public static final float[] DISABLED_COLOR = new float[] {.7f, .7f, .7f, .7f};
    ...
    protected final void renderGeometry(
        ...
        if (isDisabled()) {
            GL11.glColor4f(
                    DISABLED_COLOR[0], DISABLED_COLOR[1], DISABLED_COLOR[2], DISABLED_COLOR[3]);
        } else {
        ...
        if (align == ALIGN_LEFT) {
            ...
            text_renderer.render(
                    0,
                    0,
                    (getWidth() - getFont().getWidth(getText())) / 2,
                    clip_left,
                    clip_right,
                    clip_bottom,
                    clip_top,
            ...
            text_renderer.render(
                    0,
                    0,
                    getWidth() - getFont().getWidth(getText()),
                    clip_left,
                    clip_right,
                    clip_bottom,
                    clip_top,
