...
/**
 * A scrollable container for GUI groups, particularly useful for displaying many slider groups in a
 * limited vertical space. Implements the Scrollable interface to work with ScrollBar.
 */
public class ScrollableSliderContainer extends GUIObject implements Scrollable {
     ...
     *
     * <p>Top-down layout: first group starts at the visual top of the container and we position
     * following groups beneath it. We invert the effective layout offset (use -offsetY) so that: -
     * Pressing Up (decrease offsetY) moves content up - Pressing Down (increase offsetY) moves
     * content down while keeping ordering top-to-bottom.
     */
    private void updateLayout() {
        ...
        // Using minus layoutOffsetY effectively adds offsetY here, moving content upward for larger
        // offsets
        int currentY =
                visibleHeight
                        - topPadding
                        - layoutOffsetY; // == visibleHeight + offsetY - topPadding
