...
public strictfp class Form extends Group {
    ...
    public final void compileCanvas() {
        ...
        if (caption != null) {
            ...
            label.setPos(
                    form_data.getCaptionLeft(),
                    getHeight() - form_data.getCaptionY() - font.getHeight() / 2);
            addChild(label);
            ...
            close_button.setPos(
                    getWidth() - close_button.getWidth() - form_data.getCloseRight(),
    ...
    public final void centerPos() {
        setPos(
                (LocalInput.getViewWidth() - getWidth()) / 2,
                (LocalInput.getViewHeight() - getHeight()) / 2);
    }
        ...
        if (isDisabled()) {
            if (caption != null)
                Skin.getSkin()
                        .getFormData()
                        .getForm()
                        .render(0, 0, getWidth(), getHeight(), Skin.DISABLED);
            else
                Skin.getSkin()
                        .getFormData()
                        .getSlimForm()
            ...
            if (caption != null)
                Skin.getSkin()
                        .getFormData()
                        .getForm()
                        .render(0, 0, getWidth(), getHeight(), Skin.ACTIVE);
            else
                Skin.getSkin()
                        .getFormData()
                        .getSlimForm()
            ...
            if (caption != null)
                Skin.getSkin()
                        .getFormData()
                        .getForm()
                        .render(0, 0, getWidth(), getHeight(), Skin.NORMAL);
            else
                Skin.getSkin()
                        .getFormData()
                        .getSlimForm()
    ...
    protected final void mousePressed(int button, int x, int y) {
        ;
        if (caption != null
                && y >= getHeight() - Skin.getSkin().getFormData().getForm().getTopOffset())
            drag = true;
    }
    ...
    public final void mouseDragged(
        ...
        if (drag) setPos(getX() + rel_x, getY() + rel_y);
    }
    ...
    protected void keyPressed(KeyboardEvent event) {
        if (event.getKeyCode() == Keyboard.KEY_H && event.isControlDown()) super.keyPressed(event);
    }
