...
public final strictfp class Water {
    ...
    private final void setup() {
        ...
        if (Globals.draw_detail) {
            ...
            GL11.glEnable(GL11.GL_TEXTURE_GEN_T);
            GLUtils.setupTexGen(
                    Globals.WATER_DETAIL_REPEAT_RATE, Globals.WATER_DETAIL_REPEAT_RATE, 0, 0);
    ...
    public final void render(Sky sky) {
        ...
        sky.getWaterIndices()
                .drawRangeElements(
                        GL11.GL_TRIANGLES,
                        0,
                        sky.getWaterVertices().capacity() / 3,
                        sky.getWaterIndices().capacity(),
                        0);
    ...
    private static FloatVBO makePatchVertices(HeightMap heightmap) {
        boolean[][] water_patches =
                new boolean[heightmap.getPatchesPerWorld()][heightmap.getPatchesPerWorld()];
        int count = 0;
