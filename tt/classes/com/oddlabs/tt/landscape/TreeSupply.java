                    ...
                    .newAudio(
                            new AudioParameters(
                                    world.getRacesResources()
                                            .getTreeFallSound()[
                                            tree_type_index % 2] /* reusing native tree sounds*/,
                                    getCX(),
                                    getCY(),
                                    getCZ(),
                                    AudioPlayer.AUDIO_RANK_TREE_FALL,
                                    AudioPlayer.AUDIO_DISTANCE_TREE_FALL,
                                    AudioPlayer.AUDIO_GAIN_TREE_FALL,
                                    AudioPlayer.AUDIO_RADIUS_TREE_FALL));
