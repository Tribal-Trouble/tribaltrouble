...
public abstract strictfp class AbstractTreeGroup extends BoundingBox {
    ...
    public static final int PALMTREE_INDEX = 1;
    public static final int OAKTREE_INDEX = 2;
    public static final int PINETREE_INDEX = 3;
    ...
    public static final AbstractTreeGroup newRoot(
            World world,
            LowDetailModel[] tree_low_details,
            List tree_positions,
            List palm_tree_positions,
            int terrain_type) {
        ...
        switch (terrain_type) {
            case Landscape.NATIVE:
                root.buildTrees(
                        world, tree_low_details, TREE_INDEX, 3, 2.3f, tree_positions, 0.25f, 0.75f);
                root.buildTrees(
                        world,
                        tree_low_details,
                        PALMTREE_INDEX,
            ...
            case Landscape.VIKING:
                root.buildTrees(
                        world, tree_low_details, OAKTREE_INDEX, 3, 2.3f, tree_positions, 0.5f, 1f);
                root.buildTrees(
                        world,
                        tree_low_details,
                        PINETREE_INDEX,
    ...
    private final void buildTrees(
            final World world,
            LowDetailModel[] tree_low_details,
            final int tree_type_index,
            final int grid_size,
            final float radius,
            List tree_positions,
            float scale_factor,
