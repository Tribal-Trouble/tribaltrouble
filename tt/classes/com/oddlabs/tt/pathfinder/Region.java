...
public final strictfp class Region extends Node {
    ...
    public static final void link(Region r1, Region r2) {
        if (r1 == null || r2 == null || r1 == r2 || r1.neighbours.contains(r2)) return;
        r1.addNeighbour(r2);
        r2.addNeighbour(r1);
    }
    ...
    public final boolean addNeighbours(PathFinderAlgorithm finder, UnitGrid unit_grid) {
        for (int i = 0; i < neighbours.size(); i++) {
            ...
            if (!neighbour.isVisited())
                PathFinder.addToOpenList(
                        finder,
                        neighbour,
                        this,
                        estimateCost(neighbour.getGridX(), neighbour.getGridY()));
        }
        return false;
    }
