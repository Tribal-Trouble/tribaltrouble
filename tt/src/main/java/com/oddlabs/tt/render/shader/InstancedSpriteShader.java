        ...
        public interface Uniforms {
            ...
            private static final String VERTEX_SHADER = """
                ...
                void main() {
                    ...
                    vec3 pos1 = texelFetch(u_VertBuffer, int(in_Pos1) + gl_VertexID).xyz;
                    vec3 norm1 = texelFetch(u_VertBuffer, int(in_Norm1) + gl_VertexID).xyz;
                    
                    vec3 pos2 = texelFetch(u_VertBuffer, int(in_Pos2) + gl_VertexID).xyz;
                    vec3 norm2 = texelFetch(u_VertBuffer, int(in_Norm2) + gl_VertexID).xyz;
