...
public final class KeyBindingConflicts {
    ...
    private static final GameAction[][] CONFLICT_GROUPS = {
            ...
            {GameAction.GLOBAL_QUIT, GameAction.GLOBAL_TOGGLE_FULLSCREEN, GameAction.GLOBAL_SCREENSHOT,
                    GameAction.GLOBAL_CHAT, GameAction.GLOBAL_CHAT_TEAM, GameAction.GLOBAL_MENU,
                    GameAction.GLOBAL_TOGGLE_STATUS, GameAction.GLOBAL_AGGRESSIVE_UNITS, GameAction.CAMERA_PAN_LEFT,
                    GameAction.CAMERA_PAN_RIGHT, GameAction.CAMERA_PAN_UP, GameAction.CAMERA_PAN_DOWN,
                    GameAction.CAMERA_PITCH_UP, GameAction.CAMERA_PITCH_DOWN, GameAction.CAMERA_ROTATE_LEFT,
                    GameAction.CAMERA_ROTATE_RIGHT, GameAction.CAMERA_ZOOM_IN, GameAction.CAMERA_ZOOM_OUT,
                    GameAction.CAMERA_MAP_MODE, GameAction.CAMERA_FIRST_PERSON, GameAction.CAMERA_ZOOM_MODE,
                    GameAction.UNIT_BEACON, GameAction.UNIT_NEXT_IDLE, GameAction.NOTIFICATION_JUMP,
                    GameAction.GAME_SPEED_UP, GameAction.GAME_SPEED_DOWN, GameAction.ARMY_SELECT_0,
                    GameAction.ARMY_SELECT_1, GameAction.ARMY_SELECT_2, GameAction.ARMY_SELECT_3,
                    GameAction.ARMY_SELECT_4, GameAction.ARMY_SELECT_5, GameAction.ARMY_SELECT_6,
                    GameAction.ARMY_SELECT_7, GameAction.ARMY_SELECT_8, GameAction.ARMY_SELECT_9,
            ...
            {GameAction.UNIT_MOVE, GameAction.UNIT_ATTACK, GameAction.UNIT_GATHER, GameAction.UNIT_BUILD_QUARTERS,
                    GameAction.UNIT_BUILD_ARMORY, GameAction.UNIT_BUILD_TOWER, GameAction.UNIT_EXIT_TOWER,
                    GameAction.MAGIC_1, GameAction.MAGIC_2, GameAction.GAMEPLAY_BACK,
            },
            // Armory/Quarters top-level: production category, set-rally, train chieftain, train peon (peon batch lives here too).
            {GameAction.PROD_WEAPONS, GameAction.PROD_HARVEST, GameAction.PROD_ARMY, GameAction.PROD_TRANSPORT,
                    GameAction.UNIT_SET_RALLY, GameAction.TRAIN_CHIEFTAIN, GameAction.TRAIN_PEON,
            ...
            {GameAction.RES_TREE, GameAction.RES_TREE_DEC, GameAction.RES_TREE_BATCH, GameAction.RES_TREE_BATCH_DEC,
                    GameAction.RES_ROCK, GameAction.RES_ROCK_DEC, GameAction.RES_ROCK_BATCH,
                    GameAction.RES_ROCK_BATCH_DEC, GameAction.RES_IRON, GameAction.RES_IRON_DEC,
                    GameAction.RES_IRON_BATCH, GameAction.RES_IRON_BATCH_DEC, GameAction.RES_CHICKEN,
            ...
            {GameAction.UI_ACTIVATE, GameAction.UI_CANCEL, GameAction.UI_FOCUS_NEXT, GameAction.UI_FOCUS_PREV,
                    GameAction.UI_NEXT_PANEL, GameAction.UI_PREV_PANEL, GameAction.UI_NAV_UP, GameAction.UI_NAV_DOWN,
                    GameAction.UI_NAV_LEFT, GameAction.UI_NAV_RIGHT, GameAction.UI_NAV_HOME, GameAction.UI_NAV_END,
                    GameAction.UI_NAV_PAGE_UP, GameAction.UI_NAV_PAGE_DOWN, GameAction.UI_BACKSPACE,
