...
public final class RockAxeWeapon extends RotatingThrowingWeapon {
	...
	public RockAxeWeapon(boolean hit, @NonNull Unit src, @NonNull Selectable<?> target, SpriteKey sprite_renderer, @NonNull Audio throw_sound, Audio @NonNull [] hit_sounds) {
