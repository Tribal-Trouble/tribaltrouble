...
public final class RockSpearWeapon extends DirectedThrowingWeapon {
	...
	public RockSpearWeapon(boolean hit, @NonNull Unit src, @NonNull Selectable target, SpriteKey sprite_renderer, @NonNull Audio throw_sound, Audio @NonNull [] hit_sounds) {
