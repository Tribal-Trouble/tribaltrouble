...
public final class GeneratorDamageSmoke extends TextureGenerator {
    ...
    public @NonNull Texture @NonNull [] generate() {
        ...
        Channel smoke_alpha = new Ring(TEXTURE_SIZE, TEXTURE_SIZE, new float[][]{{0f, 1f}, {0.5f, 0f}}, Ring.Interpolation.SMOOTH).toChannel().gamma(1.5f).brightness(.5f);
        ...
        return new Texture[]{
                new Texture(smoke_img, Globals.COMPRESSED_RGBA_FORMAT, GL11.GL_LINEAR_MIPMAP_LINEAR, GL11.GL_LINEAR, GL12.GL_CLAMP_TO_EDGE, GL12.GL_CLAMP_TO_EDGE)
        };
    }
